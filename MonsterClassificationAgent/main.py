...
def test():
    ...
    known_positive_5 = {'size': 'large', 'color': 'white', 'covering': 'fur', 'foot-type': 'foot', 'leg-count': 2,
                        'arm-count': 4, 'eye-count': 2, 'horn-count': 0, 'lays-eggs': True, 'has-wings': True,
                        'has-gills': False, 'has-tail': False}
    ...
    print(f"Testcase 1 {test_agent.solve(monster_list, new_monster_1)}")
    print(f"Testcase 2 {test_agent.solve(monster_list, new_monster_2)}")
    print(f"Testcase 3 {test_agent.solve(monster_list, new_monster_3)}")
    print(f"Testcase 4 {test_agent.solve(monster_list, new_monster_4)}")
